...
During my time at Tesla, I often felt we were too over-reactive as a team. A user would report some issue on Twitter, or Elon would personally experience some issue, and we would immediately assign some engineers to investigate and fix it. It felt thrashy and frustrating. I wanted us to build a user experience committee, design a comprehensive dashboard of issues, order them by priority and impact, assign headcount as appropriate, and work through them in an orderly fashion.[^1]
...
This is easy to describe in the context of general product development. If you hear a user complaint, it's almost always the tip of the iceberg. That's not the first unhappy user, it's just the first one you heard about.
...
[^1]: I only later realized that this sort of committee-building is [effectively corporate sabotage from the CIA field manual](http://cia.gov/static/5c875f3ec660e092cf893f60b4a288df/SimpleSabotage.pdf). I have come to appreciate how little of this is present at Elon companies.
