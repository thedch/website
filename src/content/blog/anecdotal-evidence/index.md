...
I find this generally applies to anecdotal evidence in the world generally. When people learn something unexpected or new, they seem to often assume that's the full extent of it, without properly modeling the implied "tip of the iceberg". This is sort of a variation of "strong beliefs, weakly held": when you encounter surprising information, your "world model" update should be large, until proven otherwise. The succinct ML analogy is that your learning rate should be pretty high when you encounter a high loss example.